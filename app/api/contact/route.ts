      ...
      <table width="580" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;border:1px solid #e2e8f0;overflow:hidden;max-width:580px;">
        <tr>
          <td style="background:#1B2A4A;padding:20px 28px;">
            ...
            <p style="margin:4px 0 0;color:#c8d4e8;font-size:12px;">New Website Enquiry</p>
          </td>
        </tr>
        <tr>
          <td style="padding:24px 28px 16px;">
            <p style="margin:0;font-size:13px;color:#475569;">
              A new enquiry was submitted via <strong>erga.co.za</strong>.
            </p>
          </td>
        </tr>
        <tr>
          <td style="padding:0 28px;">
            <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e2e8f0;border-radius:6px;overflow:hidden;">
              ...
              ${row("Enquiry Type", esc(data.enquiryType))}
        ...
        <tr>
          <td style="padding:0 28px 24px;">
            <table cellpadding="0" cellspacing="0" style="background:#eef3fb;border-radius:6px;padding:16px 20px;width:100%;">
              <tr>
                <td>
                  <p style="margin:0 0 10px;font-size:12px;font-weight:600;color:#1B2A4A;">Contact us directly</p>
                  <p style="margin:0;font-size:13px;color:#334155;">
                    Email: <a href="mailto:info@erga.co.za" style="color:#1B2A4A;text-decoration:none;">info@erga.co.za</a>
                  </p>
                </td>
              </tr>
            </table>
        ...
        <tr>
          <td style="padding:14px 28px;background:#f8fafc;border-top:1px solid #e2e8f0;">
            <p style="margin:0;font-size:11px;color:#94a3b8;">
              Enquiry received: ${timestamp} · <a href="https://erga.co.za" style="color:#94a3b8;">erga.co.za</a>
            </p>
          </td>
        </tr>
      </table>
...
export async function POST(req: NextRequest) {
  ...
  const { name, email, phone = "", enquiryType = "", message, _trap } = body;
  ...
  try {
    await Promise.all([
      sendEmail({
        ...
        subject: `New enquiry from ${nameClean}${enquiryType ? ` — ${enquiryType}` : ""}`,
      ...
      sendEmail({
        ...
        subject: "We received your enquiry — Erga Properties",
    ...
    return NextResponse.json(
      { error: "Failed to send your message. Please try again or email us at info@erga.co.za." },
      { status: 500 },
    );
  }
}
